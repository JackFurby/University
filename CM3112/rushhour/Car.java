...
public class Car {
	...
	public List<Position> getstartEndPositions() {
		List<Position> locations = new ArrayList();
		locations.add(this.getOccupyingPositions().get(0));  // Start of car
		locations.add(this.getOccupyingPositions().get(this.getOccupyingPositions().size() - 1));  // End of car
		return locations;
	}
